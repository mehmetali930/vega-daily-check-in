 ...
 */
export const APP_NAME: string = 'vega-daily-check-in';
 ...
 */
export const APP_TAGS: string[] = ['daily', 'checkin', 'productivity', 'habit', 'tracker', 'farcaster'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Check In';
